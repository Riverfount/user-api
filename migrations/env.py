"""
Alembic env.py configurado para usar as settings do dynaconf
e detectar automaticamente os modelos SQLAlchemy.
"""
...
# ---------------------------------------------------------------------------
# Sobrescreve a sqlalchemy.url com o valor do dynaconf
# ---------------------------------------------------------------------------
def _build_url() -> str:
